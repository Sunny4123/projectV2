...
<body>
    ...
    <section class="main-travell">
        ...
        <form action="buy-detail.php?name=<?php echo $name;?>&id=<?php echo $id ?>" class="form" method="post">
            <div class="column">
                <div class="input-box">
                    <label>ชื่อ</label>
            ...
            <div class="input-box-travel">
                <label>ที่อยู่ในการจัดส่ง</label>
                <input type="text" name= "add" required />
            </div>
            <h3>ค่าจัดส่ง: 35 บาท ราคาสินค้า <?php echo $row['price']*$num ;?> บาท รวมราคาสินค้าทั้งหมด <?php  echo ($row['price']*$num)+35; ?> บาท</h3>
            <input type="text" name="price" value="<?php echo ($row['price']*$num)+35; ?>" style="opacity: 0;">
            <div class="btn">
